...
namespace test
{
    ...
    public class LogWriter
    {
        ...
        private static string logFile = "test.log";
        private static int maxLogAge = int.Parse("500000");
        private static int queueSize = int.Parse("1"); //Очередь
